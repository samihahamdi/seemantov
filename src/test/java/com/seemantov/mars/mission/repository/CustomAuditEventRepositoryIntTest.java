package com.seemantov.mars.mission.repository;

import com.seemantov.mars.mission.SeemantovdbApp;
import com.seemantov.mars.mission.config.Constants;
import com.seemantov.mars.mission.config.audit.AuditEventConverter;
import com.seemantov.mars.mission.domain.PersistentAuditEvent;
...
import static com.seemantov.mars.mission.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
